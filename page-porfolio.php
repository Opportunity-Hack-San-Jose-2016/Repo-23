...
// $accesspress_pro_portfolio_post_per_page = $accesspress_pro_settings['portfolio_post_per_page'];
...
<?php }
		...
		if(!empty($portfolio_categories) && !is_wp_error($portfolio_categories)):
			...
			echo '<li class="no-link">Category</li>';
			...
			while ( $wp_query->have_posts() ) : $wp_query->the_post(); 
				...
				<div class="portfolios-inner">
					...
					<div class="portfolio-short-desc">
						...
						<a class="portfolio-link" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=EW8EK849X9ZC6" target="_blank"><i class="fa fa-arrows-alt"></i></a>
